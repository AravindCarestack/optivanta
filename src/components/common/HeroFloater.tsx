...
function HeroFloater() {
  return (
    <div className="w-full lg:w-auto relative bg-black-gradient flex lg:p-8 py-4 hero-gradient rounded-xl shadow-2xl justify-center items-center gap-3">
      <div className=" justify-center items-center flex flex-col gap-1 lg:flex-row  lg:px-16 lg:gap-2.5">
        ...
        <div className="text-white  text-[10px] lg:text-lg font-medium  text-center lg:text-start  leading-tight">
          Quality
          <br /> Assurance
        </div>
      </div>
